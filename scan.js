import { getDexData } from "./_lib/dex.js";
import { getHolders } from "./_lib/etherscan.js";
import { getHoneypot } from "./_lib/honeypot.js";
import { calculateRisk } from "./_lib/utils.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(502).json({
      error: "TOKEN_SCAN_FAILED",
      message: "Token scan could not be completed."
    });
  }
}
